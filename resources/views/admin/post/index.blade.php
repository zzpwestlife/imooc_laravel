...
@section("content")
    <div class="box">
        <div class="box-header">
            ...
            <a type="button" class="btn" href="{{"/admin/posts/create"}}">增加帖子</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-icon btn-default" data-toggle="tooltip"
                                               href="{{"/admin/posts/create/".$item->id}}"
                                               title="编辑">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a class="btn btn-icon btn-success" data-toggle="tooltip"
                                               href="{{"/admin/post_comments/create?post_id=".$item->id}}"
                                               title="添加帖子评论">
                                            ...
                                            @if ($item->comment_count > 0)
                                                <a class="btn btn-icon btn-info"
                                                   data-toggle="tooltip"
                                                   href="{{"/admin/post_comments?post_id=".$item->id}}"
                                                   title="帖子评论管理">
